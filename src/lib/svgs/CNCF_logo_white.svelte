<svg
	...
	y="0px"
	viewBox="0 0 250 40"
	style="enable-background:new 0 0 250 40;"
	xml:space="preserve"
    class="h-12 w-auto"
>
	<style type="text/css">
	...
	></path> <path class="st0" d="M155.8,27.9v2h-4.8v2.2h4.5v2h-4.5V38h-2.3V27.9H155.8z"></path>
	<path
		class="st0"
	...
	></path>
	<g class="st1">
		<path class="st2" d="M25.3,13.2l-7.4-7.4H26V0.2H13v5.6l7.4,7.4H25.3z"></path>
		<path class="st2" d="M18.6,26.1h-4.9l6.1,6.1l1.2,1.3H13v5.6h13v-5.6l-3.7-3.6L18.6,26.1z"></path>
		<path class="st2" d="M33.4,13.2v8.1L32.1,20L26,13.9v4.9l3.7,3.6l3.7,3.7H39V13.2H33.4z"></path>
		<path class="st2" d="M13,20.5l-7.4-7.3H0v12.9h5.5V18l7.4,7.4V20.5z"></path>
		<path class="st0" d="M5.5,26.1H0v13h13v-5.6H5.5V26.1z"></path>
		<path class="st0" d="M33.4,26.2v7.4H26v5.6h13v-13L33.4,26.2L33.4,26.2z"></path>
		<path class="st0" d="M0,13.2h5.6l-0.1-0.1V5.8H13V0.2H0V13.2z"></path>
		<path class="st0" d="M26,0.2v5.6h7.4v7.4H39v-13H26z"></path>
	</g>
</svg>
