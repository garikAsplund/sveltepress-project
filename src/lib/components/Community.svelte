...
<script>
  ...
  <section class="py-12 bg-[#080c1a]" id="community">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="text-center mb-12">
        <h2 class="text-3xl font-bold text-[#a3a7ff] mb-4">Join Our Community</h2>
      </div>
      ...
      <div class="grid md:grid-cols-3 gap-8">
        ...
        <div
          ...
          transition:fade
        >
          <div class="bg-[#1c2035] p-4">
            <h3 class="text-xl font-semibold text-[#a796ff]">Community Meetings</h3>
          </div>
          <div class="p-6 flex-grow flex flex-col">
            <div class="mb-4">
              <div class="flex items-center mb-3">
                ...
                <span class="font-medium text-gray-300">Every other Wednesday</span>
              </div>
              <div class="flex items-center mb-3">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
        ...
        <div
          ...
          transition:fade
        >
          <div class="bg-[#1d2138] p-4">
            <h3 class="text-xl font-semibold text-[#a3a7ff]">Contributing</h3>
          </div>
          <div class="p-6 flex-grow flex flex-col">
        ...
        <div
          ...
          transition:fade
        >
          <div class="bg-[#1a2038] p-4">
            <h3 class="text-xl font-semibold text-[#9ba7ff]">Chat & Connect</h3>
          </div>
          <div class="p-6 flex-grow flex flex-col">
            <p class="mb-6 text-gray-300">
              Join us on the CNCF Slack in the <strong>#hyperlight</strong> channel to ask
              questions, share ideas, or just hang out with the community.
            </p>
            <div class="flex flex-col gap-4 items-center mb-6 scale-125">
              <Slack /> <span class="font-medium text-gray-300">CNCF Slack <strong>#hyperlight</strong></span>
            </div>
            <div class="mt-auto">
              <a
